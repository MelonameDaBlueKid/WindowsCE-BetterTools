...
Description: 
This sample illustrates how to create a custom Inbox transport for a Windows Mobile 6 Classic device.
...
Requirements: 
    Visual Studio 2005, Windows Mobile 2005 SDK,  Activesync 4.5.
