...
Usage: 
	...
	Settings.exe application found in the Tools\GPS\ directory where you installed the SDK.

	For more information, see SettingsReadme.txt in the same directory.

	You may also use the FakeGPS.cab in the Tools\GPS directory to use simulated GPS data. 
	For more information see FakeGPSReadme.txt in the same directory.
