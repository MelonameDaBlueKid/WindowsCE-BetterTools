...
Usage:
    ...
    A Windows CE뻖ased application that uses a modem must be able to handle 
    ...
    between a Windows CE뻖ased application and TAPI.
    ...
    lineInitialize
    The lineInitialize function initializes the application뭩 use of the 
