...
// MessageText:
//
//  This feature is not supported on UDP transport
//
...
//
// MessageId: RTC_E_BAD_RLMI_DOCUMENT
//
// MessageText:
//
//  The RLMI Document is Invalid
//
#define RTC_E_BAD_RLMI_DOCUMENT          ((HRESULT)0x80EE0086L)

//
// MessageId: RTC_E_INVALID_ID
//
// MessageText:
//
//  The Device ID is invalid.
//
#define RTC_E_INVALID_ID                 ((HRESULT)0x80EE0087L)

//
// MessageId: RTC_E_TRANSIENT_SERVER_DISCONNECT
//
// MessageText:
//
//  This operation failed because the server is unreachable or busy at this time. Please try again later.
//
#define RTC_E_TRANSIENT_SERVER_DISCONNECT ((HRESULT)0x80EE0088L)

//
// MessageId: RTC_E_SIP_AUTH_INCORRECT_REALM
//
// MessageText:
//
//  Authentication failed because realm value in incoming message does not match realm value stored in profile.
//
#define RTC_E_SIP_AUTH_INCORRECT_REALM   ((HRESULT)0x80EE0089L)

//
// MessageId: RTC_E_PROFILE_DUPLICATE_USER_URI_AND_SERVER
//
// MessageText:
//
//  A profile with the same User URI and SIP Server is already enabled.
//
#define RTC_E_PROFILE_DUPLICATE_USER_URI_AND_SERVER ((HRESULT)0x80EE008AL)

//
// MessageId: RTC_E_CANNOT_ADD_SPECIFIC_DEVICE_TO_SESSION
//
// MessageText:
//
//  Cannot add a specific device to a session.
//
#define RTC_E_CANNOT_ADD_SPECIFIC_DEVICE_TO_SESSION ((HRESULT)0x80EE008BL)

//
// MessageId: RTC_E_DIFFERENT_TRANSPORT_TO_SESSION
//
// MessageText:
//
...
//
#define RTC_E_DIFFERENT_TRANSPORT_TO_SESSION ((HRESULT)0x80EE008CL)

//
// MessageId: RTC_E_INVALID_SUBSCRIPTION_STATE
//
// MessageText:
//
//  This subscription is in an invalid state for this action.
//
#define RTC_E_INVALID_SUBSCRIPTION_STATE ((HRESULT)0x80EE008DL)
