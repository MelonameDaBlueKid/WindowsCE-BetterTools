...
Usage:
    Load the project from Visual Studio 2008, and build and deploy normally.
...
Requirements: 
    ...
    WM 6.5 Developer Resource Kit

** For more information about this code sample, please see the MSDN help system. **
