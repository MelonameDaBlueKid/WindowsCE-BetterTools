...
HANDLE WINAPI CeSetUserNotification (HANDLE hNotification, TCHAR *pwszAppName, SYSTEMTIME *lpTime, PCE_USER_NOTIFICATION lpUserNotification);

BOOL WINAPI CeClearUserNotification (HANDLE hNotification);

BOOL WINAPI CeRunAppAtTime (TCHAR *pwszAppName, SYSTEMTIME *lpTime);

BOOL WINAPI CeRunAppAtEvent(TCHAR *pwszAppName, LONG lWhichEvent);

BOOL WINAPI CeHandleAppNotifications (TCHAR *pwszAppName);

BOOL WINAPI CeGetUserNotificationPreferences (HWND hWndParent, PCE_USER_NOTIFICATION lpNotification);
#else
