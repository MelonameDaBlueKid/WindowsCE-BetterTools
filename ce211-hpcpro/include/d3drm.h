...
DECLARE_INTERFACE_(IDirect3DRM, IUnknown)
{
    ...
    STDMETHOD(LoadTexture)	(THIS_ const TCHAR *, LPDIRECT3DRMTEXTURE *) PURE;
    STDMETHOD(LoadTextureFromResource)	(THIS_ HRSRC rs, LPDIRECT3DRMTEXTURE *) PURE;
   
    STDMETHOD(SetSearchPath)	(THIS_ LPCTSTR) PURE;
    STDMETHOD(AddSearchPath)	(THIS_ LPCTSTR) PURE;
    STDMETHOD(GetSearchPath)	(THIS_ DWORD *size_return, LPTSTR path_return) PURE;
    STDMETHOD(SetDefaultTextureColors)(THIS_ DWORD) PURE;
    STDMETHOD(SetDefaultTextureShades)(THIS_ DWORD) PURE;
   
    STDMETHOD(GetDevices)	(THIS_ LPDIRECT3DRMDEVICEARRAY *) PURE;
    STDMETHOD(GetNamedObject)	(THIS_ const TCHAR *, LPDIRECT3DRMOBJECT *) PURE;
...
DECLARE_INTERFACE_(IDirect3DRM2, IUnknown)
{
    ...
    STDMETHOD(CreateUserVisual) (THIS_ D3DRMUSERVISUALCALLBACK, LPVOID lPArg, LPDIRECT3DRMUSERVISUAL *) PURE;
    STDMETHOD(LoadTexture)	(THIS_ const TCHAR *, LPDIRECT3DRMTEXTURE2 *) PURE;
