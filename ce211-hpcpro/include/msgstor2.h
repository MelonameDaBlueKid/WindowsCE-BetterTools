...
int    WINAPI MailError(              // Get last error <0=ERR >0=WRN 0=NONE
#else
...
#ifdef _WIN32_WCE_EMULATION
int     WINAPI MailErrorMsg(           // Get last mail error (printable)
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailOpen(               // Get mail started
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailOpenNotify(                 // Get mail started
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL WINAPI MailOpenNotifyEx(   // Get mail started
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailPutFolder(          // Set new folder name
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailPutFolderEx(        // Replaces MailPutFolder()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFolderName(      // Get folder name
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFolderNameEx(    // Replaces MailGetFolderName()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFolderId(        // Get folder ID
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFolderIdEx(      // Replaces MailGetFolderId()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailPut(                // Create a new mail entry
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailPutEx(              // Replaces MailPut()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailPutAttachment(              // Create a new mail attachment
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailDeleteAttachment(           // Delete a mail attachment
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGet(                // Get a message
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetEx(              // Replaces MailGet()
#else
...
#ifdef _WIN32_WCE_EMULATION
INT    WINAPI MailGetAttachment(              // Get an attachment
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailRequestAttachment(              // Request  attachment download
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL WINAPI MailGetSvcId(              // Get a message OID based on szSvcNam/Id
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL WINAPI MailGetSvcIdEx(            // Replaces MailGetSvcId
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailFirst(              // Get first mail message
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailFirstEx(            // Replaces MailFirst()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailNext(               // Get next mail message
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailNextEx(             // Replaces MailNext()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailUpdate(             // Update flags from a previous get
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailUpdateEx(           // Replaces MailUpdate()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailReadNonIPMProperties(// API for reading extra properties, such as schedule info, from a msg
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailWriteNonIPMProperties(// API for writing extra properties, such as schedule info, to a msg
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailDelete(             // Remove a mail message
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailFree(               // Give back storage from a prev Get
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailClose(              // Delete mail context
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFirstSubFolder(     // Get first sub-folder
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetNextSubFolder(     // Get the next sub-folder after the one specified
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetParent(           // Get parent folder
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailPutFolderInfo(       // Put folder info
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFolderInfo(       // Get folder info
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailFreeFolderInfo(       // Free folder info allocated by MailGetFolderInfo()
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetSpecialFolderId(       // Get ID of a special folder
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailGetFolderIdFromSvcId(       // Get folder ID from corresponding service ID
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL    WINAPI MailFreeNotification(       // Free a database notification structure
#else
...
#ifdef _WIN32_WCE_EMULATION
DWORD   WINAPI MailHeaderLen(          // Compute chars in header string
#else
...
#ifdef _WIN32_WCE_EMULATION
DWORD   WINAPI MailLocalAttachmentLen(          // Compute chars in header string
#else
...
#ifdef _WIN32_WCE_EMULATION
LPWSTR WINAPI MailGetField(            // Get one header field
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL WINAPI MailSetField(              // Set a field (FALSE=ALLOC error)
#else
...
#ifdef _WIN32_WCE_EMULATION
BOOL WINAPI MailSetAttachmentOptions(              // Set a field (FALSE=ALLOC error)
#else
...
#ifdef _WIN32_WCE_EMULATION
LONG WINAPI MailRegOpenKeyExW(         // Open a pegasus registry key
#else
...
#ifdef _WIN32_WCE_EMULATION
LONG WINAPI MailRegEnumKeyExW(         // Retrieve one key
#else
...
#ifdef _WIN32_WCE_EMULATION
LONG WINAPI MailRegCloseKey(           // Close a key
#else
