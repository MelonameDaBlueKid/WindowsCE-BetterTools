...
#define InterlockedPopEntrySList    InterlockedPopEntrySingleList
#define InterlockedPushEntrySList   InterlockedPushEntrySingleList
#define InterlockedFlushSList       InterlockedFlushSingleList
#define ReverseSList                ReverseSingleList
