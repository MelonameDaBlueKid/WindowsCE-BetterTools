...
#define DOT11_AUTH_ALGORITHM_WPA                0x00000003
#define DOT11_AUTH_ALGORITHM_WPA_PSK            0x00000004
#define DOT11_AUTH_ALGORITHM_WPA_NONE           0x00000005
...
DWORD
WINAPI
SetDot11BasicRateSet(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_RATE_SET pDot11BasicRateSet,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11BasicRateSet(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_RATE_SET pDot11BasicRateSet,
    LPVOID pvReserved
