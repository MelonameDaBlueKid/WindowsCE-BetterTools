...
#ifdef NEW_REGISTERSOFTWAREDEVICE
/* IID_IDirect3D8sw */
// {268FE9C5-D187-43df-BBBF-5BEC79BE3011}
DEFINE_GUID(IID_IDirect3D8sw, 0x268fe9c5, 0xd187, 0x43df, 0xbb, 0xbf, 0x5b, 0xec, 0x79, 0xbe, 0x30, 0x11);
#endif
...
#ifdef NEW_REGISTERSOFTWAREDEVICE
HRESULT LoadSoftwareDevice(IDirect3D8 *pD3D8, TCHAR *pLibName, TCHAR *pInitializeFunction);
#endif
...
#undef INTERFACE
#define INTERFACE IDirect3D8sw

DECLARE_INTERFACE_(IDirect3D8sw, IUnknown)
{
    /*** IUnknown methods ***/
    STDMETHOD(QueryInterface)(THIS_ REFIID riid, void** ppvObj) PURE;
    STDMETHOD_(ULONG,AddRef)(THIS) PURE;
    ...
    /*** IDirect3D8sw methods ***/
    STDMETHOD(RegisterSoftwareDevice)(THIS_ TCHAR* pLibName,TCHAR* pInitializeFunction) PURE;
};

typedef struct IDirect3D8sw *LPDIRECT3D8SW, *PDIRECT3D8SW;

#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3D8sw_QueryInterface(p,a,b) (p)->lpVtbl->QueryInterface(p,a,b)
#define IDirect3D8sw_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDirect3D8sw_Release(p) (p)->lpVtbl->Release(p)
#define IDirect3D8sw_RegisterSoftwareDevice(p,a,b) (p)->lpVtbl->RegisterSoftwareDevice(p,a,b)
#else
#define IDirect3D8sw_QueryInterface(p,a,b) (p)->QueryInterface(a,b)
#define IDirect3D8sw_AddRef(p) (p)->AddRef()
#define IDirect3D8sw_Release(p) (p)->Release()
#define IDirect3D8sw_RegisterSoftwareDevice(p,a,b) (p)->RegisterSoftwareDevice(a,b)
#endif
#endif
