...
protected:
	...
	// Databinding
WCE_DEL void BindControls(CWnd* pWndParent);
...
#if defined(_WIN32_WCE)
// WinCE: In OCCCONT.CPP, we use this "remembered value" because DLGTEMPLATEEX
// dialogs get converted to DLGTEMPLATE's, but the OLE items are still
// DIGITEMTEMPLATEEX's.
	BOOL m_bDialogEx;
#endif // _WIN32_WCE
};
