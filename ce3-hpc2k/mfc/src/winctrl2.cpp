...
#endif
		pState->m_pmapHIMAGELIST = new CHandleMap(WCE_IF(RUNTIME_CLASS(CImageList),RUNTIME_CLASS(CTempImageList)),
...
WCE_DEL IMPLEMENT_DYNAMIC(CDragListBox, CListBox)
IMPLEMENT_DYNAMIC(CSpinButtonCtrl, CWnd)
IMPLEMENT_DYNAMIC(CSliderCtrl, CWnd)
IMPLEMENT_DYNAMIC(CProgressCtrl, CWnd)
WCE_DEL IMPLEMENT_DYNAMIC(CComboBoxEx, CComboBox)
IMPLEMENT_DYNAMIC(CHeaderCtrl, CWnd)
WCE_DEL IMPLEMENT_DYNAMIC(CHotKeyCtrl, CWnd)
WCE_DEL IMPLEMENT_DYNAMIC(CAnimateCtrl, CWnd)
