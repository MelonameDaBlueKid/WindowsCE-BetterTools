...
void CRectTracker::Construct()
{
	...
	if (!bInitialized)
	{
		...
		if (_afxBlackDottedPen == NULL)
		{
			...
			_afxBlackDottedPen = WCE_FCTN(CreatePen)(PS_DOT, 0, RGB(0, 0, 0));
			if (_afxBlackDottedPen == NULL)
			{
				AfxUnlockGlobals(CRIT_RECTTRACKER);
				AfxThrowResourceException();
		...
		_afxCursors[0] = ::WCE_FCTN(LoadCursor)(hInst, MAKEINTRESOURCE(AFX_IDC_TRACKNWSE));
		_afxCursors[1] = ::WCE_FCTN(LoadCursor)(hInst, MAKEINTRESOURCE(AFX_IDC_TRACKNESW));
		_afxCursors[2] = _afxCursors[0];
		_afxCursors[3] = _afxCursors[1];
		_afxCursors[4] = ::WCE_FCTN(LoadCursor)(hInst, MAKEINTRESOURCE(AFX_IDC_TRACKNS));
		_afxCursors[5] = ::WCE_FCTN(LoadCursor)(hInst, MAKEINTRESOURCE(AFX_IDC_TRACKWE));
		_afxCursors[6] = _afxCursors[4];
		_afxCursors[7] = _afxCursors[5];
		_afxCursors[8] = ::WCE_FCTN(LoadCursor)(hInst, MAKEINTRESOURCE(AFX_IDC_TRACK4WAY));
		_afxCursors[9] = ::WCE_FCTN(LoadCursor)(hInst, MAKEINTRESOURCE(AFX_IDC_MOVE4WAY));
