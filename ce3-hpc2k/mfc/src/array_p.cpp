...
void CPtrArray::SetSize(int nNewSize, int nGrowBy)
{
	...
	else
	{
		...
		WCE_FCTN(memcpy)(pNewData, m_pData, m_nSize * sizeof(void*));
...
int CPtrArray::Append(const CPtrArray& src)
{
	...
	WCE_FCTN(memcpy)(m_pData + nOldSize, src.m_pData, src.m_nSize * sizeof(void*));
...
void CPtrArray::Copy(const CPtrArray& src)
{
	...
	WCE_FCTN(memcpy)(m_pData, src.m_pData, src.m_nSize * sizeof(void*));
