...
Compiler switches:
    ...
    -DNT35_STRICT
        Specifies that the target platform is Microsoft Windows NT 3.5. This switch disables
...
#if defined (UNDER_CE)
#define __HINST_TYPE		HANDLE
#else
#define __HINST_TYPE		HINSTANCE
#endif
