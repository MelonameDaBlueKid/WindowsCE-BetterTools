...
#define HH_DISPLAY_TRI_PANE 	0x0003	// not currently implemented
...
#define HH_KEYWORD_LOOKUP		0x000D	// not currently implemented
#define HH_DISPLAY_STRING_ID	0x000E	// display string resource id in a popup window
#define HH_DISPLAY_SEARCH		0x000F	// not currently implemented
...
#define HHWIN_PROP_NO_TOOLBAR	  (1 << 14)   // Don't display a toolbar
...
#define HHWIN_BUTTON_JUMP1			(1 << 18)	 // not implemented
#define HHWIN_BUTTON_JUMP2			(1 << 19)	 // not implemented
...
typedef struct tagHH_RESOURCE_POPUP
{
	...
	PCSTR	  pszFont;		 // facename, point size, char set, BOLD ITALIC UNDERLINE
} HH_RESOURCE_POPUP;
