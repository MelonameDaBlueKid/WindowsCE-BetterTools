...
#ifdef IE401_SP2
#define DLCTL_FORMS_SUBMIT                      0x00008000
#endif
...
// Keep all the internal dispid's together
...
#define DISPID_INTERNAL_CCURRENTSTYLEPTRCACHE   (DISPID_A_FIRST+108) // Cached CCurrentStyle Ptr
