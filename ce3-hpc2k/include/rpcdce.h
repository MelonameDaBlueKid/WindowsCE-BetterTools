...
#ifndef __RPCDCE_NT_H__
#define __RPCDCE_NT_H__
...
// RPC_POLICY EndpointFlags specific to the RPC transport:
...
// Client: RpcBindingSetOption() values for the RPC transport:
