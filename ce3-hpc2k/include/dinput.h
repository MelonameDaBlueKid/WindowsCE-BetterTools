...
#endif //!UNDER_CE
#ifdef UNDER_CE
extern const DIDATAFORMAT c_dfDISegaJoy;
#endif //UNDER_CE
...
#ifdef UNDER_CE
#define DIPROP_PORTNUMBER       MAKEDIPROP(20)
#endif //!UNDER_CE
...
typedef struct DISEGAJOYSTATE {
    LONG    lX;                     /* x-axis position              */
    LONG    lY;                     /* y-axis position              */
    LONG    lRx;                    /* x-axis rotation              */
    LONG    lRy;                    /* y-axis rotation              */
    BYTE    rgbButtons[18];         /* 32 buttons                   */
} DISEGAJOYSTATE, *LPDISEGAJOYSTATE;
