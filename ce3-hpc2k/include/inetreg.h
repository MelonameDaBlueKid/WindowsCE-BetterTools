...
// remove this when inetcpl has fixed its typo
...
// QFE 1349:  Add flag for determining whether proxy settings
//            are per user or per machine.
#define REGSTR_VAL_PROXYPERUSER         TEXT("ProxySettingsPerUser")
