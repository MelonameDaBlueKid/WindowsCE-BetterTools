...
typedef struct {
    DWORD		dwAccessType;		//INTERNET_OPEN_TYPE_DIRECT/PROXY/PRECONFIG (set only)
    LPCSTR  	lpszProxy;			//proxy server list
    LPCSTR  	lpszProxyBypass;	//proxy bypass list
} INTERNET_PROXY_INFOA, * LPINTERNET_PROXY_INFOA;
typedef struct {
    DWORD		dwAccessType;		//INTERNET_OPEN_TYPE_DIRECT/PROXY/PRECONFIG (set only)
    LPCWSTR 	lpszProxy;			//proxy server list
    LPCWSTR 	lpszProxyBypass;	//proxy bypass list
