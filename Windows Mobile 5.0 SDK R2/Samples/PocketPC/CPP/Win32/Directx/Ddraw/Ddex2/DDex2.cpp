...
// Local data
//-----------------------------------------------------------------------------
static const TCHAR          szBackground[] = TEXT("BACK");
...
static const TCHAR          szDDReLoadBitmapFailMsg[] = TEXT("DDReLoadBitmap failed.");
...
InitApp(int nCmdShow)
{
    ...
    hRet = DDReLoadBitmap(hInstance, g_pDDSBack, szBackground);
    if (hRet != DD_OK)
        return InitFail(hWnd, hRet, szDDReLoadBitmapFailMsg);
