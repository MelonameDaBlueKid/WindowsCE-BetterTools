...
WSAAPI
gethostname(
    __out_bcount(namelen) OUT char FAR * name,
    IN int namelen
    );
#endif /* INCL_WINSOCK_API_PROTOTYPES */
...
WSAAddressToStringA(
    ...
    IN     LPWSAPROTOCOL_INFOA lpProtocolInfo,
    __inout_ecount(*lpdwAddressStringLength) IN OUT LPSTR             lpszAddressString,
...
WSAAddressToStringW(
    ...
    IN     DWORD               dwAddressLength,
    IN     LPWSAPROTOCOL_INFOW lpProtocolInfo,
    __inout_ecount(*lpdwAddressStringLength) IN OUT LPWSTR             lpszAddressString,
    IN OUT LPDWORD             lpdwAddressStringLength
    );
#ifdef UNICODE
