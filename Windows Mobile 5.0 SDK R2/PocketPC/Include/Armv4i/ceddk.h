...
BOOL    GetBusNamePrefix(HANDLE hBusAccess, __out_ecount(dwSizeInCharacters) LPTSTR lpReturnStr,DWORD dwSizeInCharacters);
...
BOOL    BusIoControl(HANDLE hBusAccess, DWORD dwIoControlCode, __out_bcount_opt(nInBufferSize) LPVOID lpInBuffer, DWORD nInBufferSize, __out_bcount(nInBufferSize) LPVOID lpOutBuffer, DWORD nOutBufferSize, LPDWORD lpBytesReturned, LPOVERLAPPED lpOverlapped);
