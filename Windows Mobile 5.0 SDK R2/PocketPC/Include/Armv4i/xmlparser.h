...
EXTERN_C const IID IID_IXMLParser2;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetMaxXmlSize( 
            /* [out] */ ULONG __RPC_FAR *MaxSizeCch) = 0;
    ...
    typedef struct IXMLParser2Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetMaxXmlSize )( 
            IXMLParser2 __RPC_FAR * This,
            /* [in] */ ULONG MaxSizeCch);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetMaxXmlSize )( 
            IXMLParser2 __RPC_FAR * This,
            /* [out] */ ULONG __RPC_FAR *MaxSizeCch);
    ...
    interface IXMLParser2
    {
        CONST_VTBL struct IXMLParser2Vtbl __RPC_FAR *lpVtbl;
    };
