...
void CBMTest1Dlg::OnActivate( UINT nState, CWnd* pWndOther, BOOL bMinimized )
{
...
void CBMTest2Dlg::OnActivate( UINT nState, CWnd* pWndOther, BOOL bMinimized )
{
	CDialog::OnActivate(nState, pWndOther, bMinimized);
	if(nState == WA_ACTIVE)
	{
...
{
	::SetDlgItemInt(m_hWnd, IDC_NUMBEROUT, m_nNumber, TRUE);
...
void CBMTest3Dlg::OnActivate( UINT nState, CWnd* pWndOther, BOOL bMinimized )
{
	CDialog::OnActivate(nState, pWndOther, bMinimized);
	if(nState == WA_ACTIVE)
	{
