...
WCE_DEL _AFXWIN_INLINE int CWnd::SetWindowRgn(HRGN hRgn, BOOL bRedraw)
WCE_DEL { ASSERT(::IsWindow(m_hWnd)); return ::SetWindowRgn(m_hWnd, hRgn, bRedraw); }
WCE_DEL _AFXWIN_INLINE int CWnd::GetWindowRgn(HRGN hRgn) const
WCE_DEL { ASSERT(::IsWindow(m_hWnd) && hRgn != NULL); return ::GetWindowRgn(m_hWnd, hRgn); }
...
WCE_DEL _AFXWIN_INLINE int CWnd::GetUpdateRgn(CRgn* pRgn, BOOL bErase)
WCE_DEL	{ ASSERT(::IsWindow(m_hWnd)); return ::GetUpdateRgn(m_hWnd, (HRGN)pRgn->GetSafeHandle(), bErase); }
...
WCE_DEL _AFXWIN_INLINE CCheckListBox::CCheckListBox()
WCE_DEL { m_cyText = 0; m_nStyle = 0; }
WCE_DEL _AFXWIN_INLINE UINT CCheckListBox::GetCheckStyle()
WCE_DEL { return m_nStyle; }
