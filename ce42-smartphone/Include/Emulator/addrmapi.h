...
#ifndef PT_BOOLEAN
#define BOGUS_PT_BOOLEAN_DEFINED
#define PT_BOOLEAN  pt_boolean_is_pt_i2_here_but_should_be_CEVT_I2
#endif
...
#define PR_REPLY_REQUESTED                    PROP_TAG( CEVT_I2,   0x0C17)
#endif
#define PR_REPLY_TIME                         PROP_TAG( PT_SYSTIME,   0x0030)
#ifndef PR_RESPONSE_REQUESTED
#define PR_RESPONSE_REQUESTED                 PROP_TAG( CEVT_I2,   0x0063)
#endif
...
// device and desktop (which uses MAPI with a different valued PT_BOOLEAN) replication.
...
#define HHPR_CUSTOM_DISPLAY_FIELDS            PROP_TAG(PT_UNICODE, 0x4317)  // -- this should stay 4317, not 8317
// 10 so far
...
#define HHPR_EMAIL1_EMAIL_ADDRESS_SHADOW      PROP_TAG(PT_UNICODE, 0x8100)
#define HHPR_EMAIL2_EMAIL_ADDRESS_SHADOW      PROP_TAG(PT_UNICODE, 0x8101)
// 50 so far
#define HHPR_EMAIL3_EMAIL_ADDRESS_SHADOW      PROP_TAG(PT_UNICODE, 0x8102)
#define HHPR_REPLICATION_ID                   PROP_TAG(PT_UNICODE, 0x8103)
...
#define HHPR_YOMI_FILEAS_SORT                 PROP_TAG(PT_UNICODE, 0x8321)

// How many address card properties were there?
#ifdef JAPAN
#define HHAB_CARD_NUMPROPS          56
#else  //JAPAN
#define HHAB_CARD_NUMPROPS          50
#endif //JAPAN
