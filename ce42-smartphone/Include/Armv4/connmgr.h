...
// @constdefine Voice, highest priority
...
// @constdefine Cached connection, used internally.
...
#define CONNMGR_STATUS_WAITINGFORNETWORK          0x42  // @constdefine No path could be found to destination
