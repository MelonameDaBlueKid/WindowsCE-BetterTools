...
#if defined (_M_AM)
float _rsqrtf_approx(float);

#if !defined(_CMNINTRIN_DECLARE_ONLY)
#pragma intrinsic(_rsqrtf_approx)
#endif
...
#define _INTRINSIC__rsqrt_approx        _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
...
#define _INTRINSIC__CopyInt32FromFloat  _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CopyInt64FromDouble _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CopyFloatFromInt32  _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CopyDoubleFromInt64 _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
...
//string and block
#define _INTRINSIC_memchr               _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
...
#define _INTRINSIC___CacheRelease        _INTRINSIC_UNSUPPORTED
#define _INTRINSIC___CacheWriteback      _INTRINSIC_UNSUPPORTED
...
#define _INTRINSIC___ICacheRefresh       _INTRINSIC_UNSUPPORTED
#define _INTRINSIC__InterlockedAdd       _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_UNSAFE
...
#define _INTRINSIC__ReadWriteBarrier     _INTRINSIC_UNSUPPORTED
...
#define _INTRINSIC__WriteBarrier         _INTRINSIC_UNSUPPORTED

#endif //_M_AM

// common intrinsic function support for SH-3, SH-4 and SH-5
#if defined(_M_SH)
#if (_M_SH>=5)
...
#if (_M_SH<4)
#define _INTRINSIC_fabs                 _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC_fabsf                _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC_sqrt                 _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC_sqrtf                _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#else
...
#if _M_SH>=5
#define _INTRINSIC__InterlockedExchange64 _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#endif
...
#define _INTRINSIC__InterlockedExchange _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_UNSAFE        
#define _INTRINSIC___prefetch           _INTRINSIC_UNSUPPORTED
#define _INTRINSIC__ReadWriteBarrier    _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__ReturnAddress       _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC___trap               _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_UNSAFE
#define _INTRINSIC__WriteBarrier        _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
...
#define _INTRINSIC_abs                  _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__abs64               _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__byteswap_ushort     _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__byteswap_ulong      _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__byteswap_uint64     _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingOnes    _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingSigns   _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingZeros   _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingOnes64  _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingSigns64 _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingZeros64 _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountOneBits        _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountOneBits64      _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC_labs                 _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__lrotl               _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__lrotr               _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__MulHigh             _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__MulUnsignedHigh     _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotl                _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotl64              _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotr                _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotr64              _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
...
#define _INTRINSIC__ReadWriteBarrier     _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__ReturnAddress        _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC___trap                _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_UNSAFE
#define _INTRINSIC__WriteBarrier         _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#endif //_M_TRICORE
...
#define _INTRINSIC__byteswap_ulong      _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__byteswap_uint64     _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingOnes    _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingSigns   _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingZeros   _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingOnes64  _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingSigns64 _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountLeadingZeros64 _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__CountOneBits        _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
...
#define _INTRINSIC__MulUnsignedHigh     _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotl                _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotl64              _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotr                _INTRINSIC_INLINE|_INTRINSIC_SYSTEM_SAFE
#define _INTRINSIC__rotr64              _INTRINSIC_HELPER|_INTRINSIC_SYSTEM_SAFE
