...
#endif /* WINVER >= 0x0400 */
#define OFN_PROJECT					 0x00400000     // If this flag is set, the GetOpenFileName API will open the Project dialog for Pocket PC
#define OFN_PROPERTY				 0x00800000     // If this flag is set, the GetSaveFileName API will open the Propery dialog for Pocket PC
#define OFN_SHOW_ALL                 0x01000000     // If OFN_PROJECT is set,  show the <All Folders> item
// Show "make available offline" and "synchronize" check boxes in Save As...
// dialog.  Also makes the root folder the favorites dir rather than My Docs.
...
// These flags are sent back through lCustData when OFN_SHOWFAVORITESOPTS is
// set.

#define OFNFAVDATA_SYNCHRONIZE   0x80000000
#define OFNFAVDATA_AVAILOFFLINE  0x40000000
...
#define CDERR_FINDRESFAILURE   0x0004
#define CDERR_LOADRESFAILURE   0x0005
#define CDERR_LOCKRESFAILURE   0x0006
#define CDERR_MEMALLOCFAILURE  0x0007
#define CDERR_NOHOOK           0x0008
#define CDERR_REGISTRYFAILURE  0x0009
#define CDERR_NOHINSTANCE      0x000A

#define PDERR_NODEFAULTPRN     0x1000
#define PDERR_PRINTERNOTFOUND  0x1001
#define PDERR_NOPORTS          0x1002
#define PDERR_NOPRINTERS       0x1003
#define PDERR_CREATEDCFAILURE  0x1004
