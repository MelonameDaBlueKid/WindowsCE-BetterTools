...
#define CCF_DEFAULT                         0x00
#define CCF_HIDENEW                         0x01
#define CCF_CHOOSECONTACTONLY               0x02
#define CCF_CHOOSEPROPERTYONLY              0x04
#define CCF_RETURNCONTACTNAME               0x08
#define CCF_RETURNPROPERTYVALUE             0x10
#define CCF_FILTERREQUIREDPROPERTIES        0x20
#define CCF_NOUIONSINGLEORNOMATCH           0x40
#define CCF_NOUI                            0x80
...
#define PIMPR_MEETING_OWNER_CRITICAL_CHANGE   PIM_PROP_TAG( CEVT_FILETIME, 0x0052) // MeetingOwnerCriticalChange: A timestamp indicating that the meeting owner wants to update the meeting request. Required when sending an updated meeting request to attendees.
...
// Registry keys, paths and value names
