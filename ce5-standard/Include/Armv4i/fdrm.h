...
//      to ensure that the object can be used as intended. It must do this 
//      even if it has already called FileDrmGetRights and done its own 
//      verification. This API will verify if the object has the appropriate 
//      rights and if necessary will prompt the user if they want to consume
//      rights or renew expired rights.
// **************************************************************************
