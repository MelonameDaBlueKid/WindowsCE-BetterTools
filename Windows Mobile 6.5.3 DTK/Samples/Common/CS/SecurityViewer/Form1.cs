...
namespace SecurityViewer
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void Form1_Load(object sender, System.EventArgs e)
        {
            ...
            xmlCerts.LoadXml("<wap-provisioningdoc>" +
            ...
            xmlPolicy.LoadXml("<wap-provisioningdoc>" + 
                                "<characteristic type=\"SecurityPolicy\">" +
                                    "<parm-query name=\"2\"/>" + 
                                    "<parm-query name=\"4097\"/>" + 
                                    "<parm-query name=\"4101\"/>" + 
                                    "<parm-query name=\"4103\"/>" + 
                                    "<parm-query name=\"4104\"/>" + 
                                    "<parm-query name=\"4105\"/>" + 
                                    "<parm-query name=\"4108\"/>" + 
                                    "<parm-query name=\"4109\"/>" + 
                                    "<parm-query name=\"4110\"/>" + 
                                    "<parm-query name=\"4111\"/>" + 
                                    "<parm-query name=\"4112\"/>" + 
                                    "<parm-query name=\"4113\"/>" + 
                                    "<parm-query name=\"4119\"/>" + 
                                    "<parm-query name=\"4120\"/>" + 
                                    "<parm-query name=\"4121\"/>" + 
                                    "<parm-query name=\"4129\"/>" + 
                                    "<parm-query name=\"4102\"/>" + 
                                    "<parm-query name=\"4122\"/>" + 
                                    "<parm-query name=\"4123\"/>" +
                                    "<parm-query name=\"4141\"/>" +
                                    "<parm-query name=\"4142\"/>" +
                                    "<parm-query name=\"4143\"/>" +
                                  "</characteristic>" +
                                "</wap-provisioningdoc>");
