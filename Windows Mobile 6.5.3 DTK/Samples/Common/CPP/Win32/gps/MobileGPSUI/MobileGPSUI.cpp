...
// MobileGPS.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "MobileGPSUI.h"
#include <windows.h>
#include <commctrl.h>
#include <Gpsapi.h>
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
	...
	wc.hIcon         = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MOBILEGPS));
	wc.hCursor       = 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    LoadString(hInstance, IDC_MOBILEGPS, szWindowClass, MAX_LOADSTRING);
