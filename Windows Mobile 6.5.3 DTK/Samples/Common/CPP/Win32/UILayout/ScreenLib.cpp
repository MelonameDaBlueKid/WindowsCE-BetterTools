...
void CScreenLib::DockControl(HWND hwndDlg, UINT nIDAffectedCtl, SCREENLIB_DOCK nType /*= SCREENLIB_DOCK_FILL*/)
{
	ASSERT(hwndDlg != NULL);
	RECT rcClient;
