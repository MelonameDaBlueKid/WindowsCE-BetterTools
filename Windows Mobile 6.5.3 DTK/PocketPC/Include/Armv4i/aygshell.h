...
//
// Start Menu button press
//
#define IDM_STARTMENU         14
...
#define SHCMBF_SOFTKEYICONS  0x0020 // allow icons on softkeys - this flag is only valid for PPC
#define SHCMBF_DISABLEDSOFTKEYICONS  0x0040 // allow disabled-state icons on softkeys (bitmap ID must be one plus the enabled-state bitmap ID) - this flag is only valid for PPC
#define SHCMBF_THEMEBITMAPS 0x0080  // allow using theme primitive bitmap for softkeybar icons.
...
// BubbleBar theme icon defines. These are imagelist indexes to be referenced in the menubar resource for a BubbleBar.
// Note 1: Their order has to match the BubbleTile ~ Magnifier theme primitive (ThemePrimitive_BubbleTile_* ~ ThemePrimitive_Magnifier_*) order
// Note 2: These values must be pound defines to ensure that resource files can use them
#define SHCMBF_THEME_ICON_INVALID               0x1000
#define SHCMBF_THEME_ICON_X                     0x1001 //(SHCMBF_THEME_ICON_INVALID+1)
#define SHCMBF_THEME_ICON_X_DISABLED            0x1002 //(SHCMBF_THEME_ICON_INVALID+2)
#define SHCMBF_THEME_ICON_OK                    0x1003 //(SHCMBF_THEME_ICON_INVALID+3)
#define SHCMBF_THEME_ICON_OK_DISABLED           0x1004 //(SHCMBF_THEME_ICON_INVALID+4)
#define SHCMBF_THEME_ICON_NAVBACK               0x1005 //(SHCMBF_THEME_ICON_INVALID+5)
#define SHCMBF_THEME_ICON_NAVBACK_DISABLED      0x1006 //(SHCMBF_THEME_ICON_INVALID+6)
#define SHCMBF_THEME_ICON_NAVFWD                0x1007 //(SHCMBF_THEME_ICON_INVALID+7)
#define SHCMBF_THEME_ICON_NAVFWD_DISABLED       0x1008 //(SHCMBF_THEME_ICON_INVALID+8)
#define SHCMBF_THEME_ICON_MENU                  0x1009 //(SHCMBF_THEME_ICON_INVALID+9)
#define SHCMBF_THEME_ICON_MENU_DISABLED         0x100a //(SHCMBF_THEME_ICON_INVALID+10)
#define SHCMBF_THEME_ICON_FLAG                  0x100b //(SHCMBF_THEME_ICON_INVALID+11)
#define SHCMBF_THEME_ICON_FLAG_DISABLED         0x100c //(SHCMBF_THEME_ICON_INVALID+12)
#define SHCMBF_THEME_ICON_LOCK                  0x100d //(SHCMBF_THEME_ICON_INVALID+13)
#define SHCMBF_THEME_ICON_LOCK_DISABLED         0x100e //(SHCMBF_THEME_ICON_INVALID+14)
#define SHCMBF_THEME_ICON_CONTACTS              0x100f //(SHCMBF_THEME_ICON_INVALID+15)
#define SHCMBF_THEME_ICON_CONTACTS_DISABLED     0x1010 //(SHCMBF_THEME_ICON_INVALID+16)
#define SHCMBF_THEME_ICON_PHONE                 0x1011 //(SHCMBF_THEME_ICON_INVALID+17)
#define SHCMBF_THEME_ICON_PHONE_DISABLED        0x1012 //(SHCMBF_THEME_ICON_INVALID+18)
#define SHCMBF_THEME_ICON_NEW                   0x1013 //(SHCMBF_THEME_ICON_INVALID+19)
#define SHCMBF_THEME_ICON_NEW_DISABLED          0x1014 //(SHCMBF_THEME_ICON_INVALID+20)
#define SHCMBF_THEME_ICON_EDIT                  0x1015 //(SHCMBF_THEME_ICON_INVALID+21)
#define SHCMBF_THEME_ICON_EDIT_DISABLED         0x1016 //(SHCMBF_THEME_ICON_INVALID+22)
#define SHCMBF_THEME_ICON_DELETE                0x1017 //(SHCMBF_THEME_ICON_INVALID+23)
#define SHCMBF_THEME_ICON_DELETE_DISABLED       0x1018 //(SHCMBF_THEME_ICON_INVALID+24)
#define SHCMBF_THEME_ICON_HOME                  0x1019 //(SHCMBF_THEME_ICON_INVALID+25)
#define SHCMBF_THEME_ICON_HOME_DISABLED         0x101a //(SHCMBF_THEME_ICON_INVALID+26)
#define SHCMBF_THEME_ICON_SNOOZE                0x101b //(SHCMBF_THEME_ICON_INVALID+27)
#define SHCMBF_THEME_ICON_SNOOZE_DISABLED       0x101c //(SHCMBF_THEME_ICON_INVALID+28)
#define SHCMBF_THEME_ICON_DISMISS               0x101d //(SHCMBF_THEME_ICON_INVALID+29)
#define SHCMBF_THEME_ICON_DISMISS_DISABLED      0x101e //(SHCMBF_THEME_ICON_INVALID+30)
#define SHCMBF_THEME_ICON_MAGNIFIER_ZOOMOUT     0x101f //(SHCMBF_THEME_ICON_INVALID+31), ThemePrimitive_Magnifier_ZoomOut
#define SHCMBF_THEME_ICON_COUNT                 0x1020 //(SHCMBF_THEME_ICON_INVALID+32)
...
#define BUBBLEBAR_NUM_BUTTONS   5 // Number of buttons in the bubble bar
...
#define SHIC_CLASS_URL_BOOKMARK         TEXT("urlbookmark")
#define SHIC_CLASS_PHONE                TEXT("phone")
#define SHIC_CLASS_PHONENUMBER          TEXT("phonenumber")
#define SHIC_CLASS_NAME                 TEXT("name")
#define SHIC_CLASS_PHONE_AND_EMAIL      TEXT("phoneAndEmail")
#define SHIC_CLASS_EMAILDOMAIN          TEXT("emaildomain")
#define SHIC_CLASS_EMAILDOMAINONLY      TEXT("emaildomainonly")
...
//                                      SHIC_CLASS_URL_BOOKMARK, SHIC_CLASS_PHONE, SHIC_CLASS_PHONENUMBER,
//                                      SHIC_CLASS_NAME, SHIC_CLASS_PHONE_AND_EMAIL,
//                                      SHIC_CLASS_EMAILDOMAIN, SHIC_CLASS_EMAILDOMAINONLY)
//
...
// Notification data structure with bubble tile information
typedef struct _SHNOTIFICATIONDATAEX
{
    ...
    SHBUBBLETILEINFO bti; //Bubble tile info structure
...
//Allow SHBoxEx to automatically scale the text and inputs in the HTML
//to be more touchable.
#define SHNF_AUTOSIZEHTML    0x01000000

// Indicates that this notification should not appear in the TitleBarList
#define SHNF_NOTITLEBARLISTICON 0x0200000
...
//++++++
//
// SHNotificationSetListItemResource
//
//   Sets the large icon to use for this notification when it appears in the title bar list

LRESULT SHNotificationSetListItemResource(const SHNOTIFICATIONDATA *pndIn, TCHAR* pszResourceDll, UINT uResId, UINT uResOverrideId);

//
// End SHNotificationSetLargeIcon
//
//------

//++++++
//
// SHNotificationSetOnSelectCmd
//
//   Sets the command id to use with WM_COMMAND when the notification is selected from the title bar list

LRESULT SHNotificationSetOnSelectCmd(const SHNOTIFICATIONDATA *pndIn, WPARAM wp);

//
// End SHNotificationSetOnSelectCmd
//
//------
