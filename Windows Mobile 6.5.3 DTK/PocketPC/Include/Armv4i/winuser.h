...
#define DS_EX_FORCENOAUTOLAYOUT 0x02000000L
...
MsgWaitForMultipleObjectsEx(
    DWORD nCount,
    __out_ecount_opt(nCount) LPHANDLE pHandles,
...
#define MOUSEEVENTF_SENDINPUT   0x400000
...
#define BS_THEME            0x00008000L // Theme button style

#define BS_EX_SIZEWITHTEXT     0x00000001L
#define BS_EX_SIZEWITHCONTROL  0x00000002L
#define BS_EX_SIZEMASK         0x00000003L
...
// @CESYSGEN IF COMMCTRL_CUTCOPYPASTE
/*
 *  Cut Copy Paste common control definitions.
 */

// CutCopyPaste messages 
#define CCPM_GETSELSNAP          0x00E5
#define CCPM_CONTEXTMENU         0x00E6
#define CCPM_ENTERSELECTIONMODE  0x00E7 

// Data sent in LPARAM of CCPM_GETSELSNAP message. 
typedef struct tagGETSELSNAPINFO
{
    BOOL  fSelecting;
    BOOL  fLastSelectionPoint;
    LONG  lSelStartHeight;
    LONG  lSelEndHeight;
    POINT ptStart;
    POINT ptEnd;
} GETSELSNAPINFO, *PGETSELSNAPINFO;
// @CESYSGEN ENDIF
...
#define DM_ANIMATE          (WM_USER+3)
#define DM_ANIMATESTATUS    (WM_USER+4)
...
HWND
WINAPI
AutoLayoutCreateDialogIndirectParamW(
    HINSTANCE hInstance,
...
int
WINAPI
AutoLayoutDialogBoxIndirectParamW(
    HINSTANCE hInstance,
    LPCDLGTEMPLATEW lpTemplate,
    HWND hWndParent,
    DLGPROC lpDialogFunc,
...
CreateDialogIndirectParamW(
    ...
    DLGPROC lpDialogFunc,
    LPARAM dwInitParam);
#define CreateDialogIndirectParamAutoLayoutW    CreateDialogIndirectParamW
#define CreateDialogIndirectParamAutoLayoutA    CreateDialogIndirectParamA

#ifdef UNICODE
#define CreateDialogIndirectParam  CreateDialogIndirectParamAutoLayoutW
#else
#define CreateDialogIndirectParam  CreateDialogIndirectParamAutoLayoutA
#endif // !UNICODE
...
#define CreateDialogIndirectA(hInstance, lpTemplate, hWndParent, lpDialogFunc) \
    CreateDialogIndirectParamAutoLayoutA(hInstance, lpTemplate, hWndParent, lpDialogFunc, 0L)
#define CreateDialogIndirectW(hInstance, lpTemplate, hWndParent, lpDialogFunc) \
    CreateDialogIndirectParamAutoLayoutW(hInstance, lpTemplate, hWndParent, lpDialogFunc, 0L)
#ifdef UNICODE
...
#define CreateDialogParamA(hInstance, lpszDlgName, hwndOwner, lpfnDialog, lParam)    \
    CreateDialogIndirectParamAutoLayoutA(hInstance,   \
...
#define CreateDialogParamW(hInstance, lpszDlgName, hwndOwner, lpfnDialog, lParam)    \
    CreateDialogIndirectParamAutoLayoutW(hInstance,   \
...
DialogBoxIndirectParamW(
    ...
    DLGPROC lpDialogFunc,
    LPARAM dwInitParam);
#define DialogBoxIndirectParamAutoLayoutW       DialogBoxIndirectParamW
#define DialogBoxIndirectParamAutoLayoutA       DialogBoxIndirectParamA
    
#ifdef UNICODE
#define DialogBoxIndirectParam  DialogBoxIndirectParamAutoLayoutW
#else
#define DialogBoxIndirectParam  DialogBoxIndirectParamAutoLayoutA
#endif // !UNICODE
...
#define DialogBoxIndirectA(hInstance, lpTemplate, hWndParent, lpDialogFunc) \
    DialogBoxIndirectParamAutoLayoutA(hInstance, lpTemplate, hWndParent, lpDialogFunc, 0L)
#define DialogBoxIndirectW(hInstance, lpTemplate, hWndParent, lpDialogFunc) \
    DialogBoxIndirectParamAutoLayoutW(hInstance, lpTemplate, hWndParent, lpDialogFunc, 0L)
#ifdef UNICODE
...
#define DialogBoxParamA(hInstance, lpszDlgName, hwndOwner, lpfnDialog, lParam)    \
    DialogBoxIndirectParamAutoLayoutA(hInstance,   \
        (LPCDLGTEMPLATEA)LoadResource(hInstance, FindResource(hInstance, lpszDlgName, RT_DIALOG)), \
        hwndOwner, lpfnDialog, lParam)
#define DialogBoxParamW(hInstance, lpszDlgName, hwndOwner, lpfnDialog, lParam)    \
    DialogBoxIndirectParamAutoLayoutW(hInstance,   \
        (LPCDLGTEMPLATEW)LoadResource(hInstance, FindResource(hInstance, lpszDlgName, RT_DIALOG)), \
        hwndOwner, lpfnDialog, lParam)
#ifdef UNICODE
...
#define LBS_EX_THEME             0x00000004L
// @CESYSGEN ENDIF
...
#define CBS_EX_THEME            0x00000004L
...
#ifdef _MSDLGMGRUSEAUTOLAYOUT

#include <autolayout.h>

#endif // _MSDLGMGRUSEAUTOLAYOUT

#ifdef WINCEOEM

#include <pwinuser.h>   // internal defines

// Additional internal defines that depend on other definitions in winuser.h
#define THEMEPRIMITIVE_MAXPADDING_X GetSystemMetrics(SM_CXSCREEN)
#define THEMEPRIMITIVE_MAXPADDING_Y GetSystemMetrics(SM_CYSCREEN)

#endif

// Style to disable the magnifier for a window and all of the window's children
#define WS_EX_NOMAGNIFIER             0x00800000L

// Messages sent to controls for higher fidelity in magnifier control
#define WM_MAGNIFIER_NCMOUSEMOVE      (0x03F0)     // wp = hWndScope  lp = MAKELPARAM(pt.x, pt.y) 
#define WM_MAGNIFIER_MOUSEMOVE        (0x03F1)     // wp = hWndScope  lp = MAKELPARAM(pt.x, pt.y)
#define WM_MAGNIFIER_DRAWITEM         (0x03F2)     // wp = n/a        lp = (LPARAM)(SCMDRAWITEMSTRUCT *)

/*
 *  SCMDRAWITEMSTRUCT
 */
typedef struct tagSCMDRAWITEMSTRUCT {
    HWND    hwndScope;
    HDC     hDC;
    RECT    rcDraw;
    HWND    hwndItem;
    POINT   ptItem;
} SCMDRAWITEMSTRUCT, *PSCMDRAWITEMSTRUCT, *LPSCMDRAWITEMSTRUCT;
