...
#define EXTENDED_VIBRATE_SCREENTAPOFF   (-1002) 
#define EXTENDED_VIBRATE_SCREENTAPON    (-1001)
#define EXTENDED_VIBRATE_DEFAULT        (-1000)
#define EXTENDED_VIBRATE_TODAY          (EXTENDED_VIBRATE_DEFAULT+1)
#define EXTENDED_VIBRATE_START          (EXTENDED_VIBRATE_DEFAULT+2)
#define EXTENDED_VIBRATE_MENU           (EXTENDED_VIBRATE_DEFAULT+3)
#define EXTENDED_VIBRATE_BUTTON         (EXTENDED_VIBRATE_DEFAULT+4)
#define EXTENDED_VIBRATE_SIP            (EXTENDED_VIBRATE_DEFAULT+5)
#define EXTENDED_VIBRATE_SETTINGS       (EXTENDED_VIBRATE_DEFAULT+6)
#define EXTENDED_VIBRATE_PROGRAMS       (EXTENDED_VIBRATE_DEFAULT+7)
#define EXTENDED_VIBRATE_DIALER         (EXTENDED_VIBRATE_DEFAULT+8)
#define EXTENDED_VIBRATE_LOCKSCREEN     (EXTENDED_VIBRATE_DEFAULT+9)
#define EXTENDED_VIBRATE_NOTIFICATIONS  (EXTENDED_VIBRATE_DEFAULT+10)
#define EXTENDED_VIBRATE_WMP            (EXTENDED_VIBRATE_DEFAULT+11)
#define EXTENDED_VIBRATE_CONTACTS       (EXTENDED_VIBRATE_DEFAULT+12)
#define EXTENDED_VIBRATE_MESSAGING      (EXTENDED_VIBRATE_DEFAULT+13)
#define EXTENDED_VIBRATE_LISTVIEW       (EXTENDED_VIBRATE_DEFAULT+14)
