...
//    NOCCPCTL     Cut Copy Paste control.
//
//=============================================================================
...
#define ICC_CUTCOPYPASTE_CLASS     0x00004000   // cut copy paste control
...
#define TBSTYLE_BT_TAPANDHOLD   0x0020 // send notification on tab and hold on a button. Do not set it to toolbar as window style
#define TBSTYLE_USELABELASTOOLTIP 0x0040 // if TBSTYLE_TOOLTIPS is enabled, then this button's label is used for its tooltip text. Do not set it to toolbar as window style
#endif
...
#if (_WIN32_IE >= 0x0400)
// Extended toolbar styles
// Note: These style flags must not overlap with the WS_EX_* standard extended window style flags (see winuser.h and pwinuser.h)
#define TBSTYLE_EX_CENTER          0x0002
#define TBSTYLE_EX_VCENTER         0x0004
#define TBSTYLE_EX_AUTOPOS_ODD     0x0010
#define TBSTYLE_EX_THEMEDBUTTONS   0x0020
#define TBSTYLE_EX_TOOLTIPSABOVE   0x0040
#define TBSTYLE_EX_ENFORCEBUTTONTEXT    0x0080
#endif
...
#define TBIF_BYINDEX            0x80000000 // this specifies that the wparam in TB_GETBUTTONINFO/TB_SETBUTTONINFO is an index, not id
...
#ifdef _WIN32
#define CCPCTLCLASSNAMEW       L"CcpControlWindow32"
#define CCPCTLCLASSNAMEA       "CcpControlWindow32"

#ifdef  UNICODE
#define CCPCTLCLASSNAME        CCPCTLCLASSNAMEW
#else
#define CCPCTLCLASSNAME        CCPCTLCLASSNAMEA
#endif
#else
#define CCPCTLCLASSNAME        "CcpControlWindow"
#endif

// Style flags
#define CCPSTYLE_HIDE_CUT           0x00000001                                                                                   
#define CCPSTYLE_HIDE_PASTE         0x00000002
#define CCPSTYLE_HIDE_MENU          0x00000004

typedef enum tagCcpMode
{
   CCP_MODE_HIDE,
   CCP_MODE_SHOW_POSITION,
   CCP_MODE_SHOW_SELECTION,
   CCP_MODE_NUMMODES,         // This must always be the last entry.
} CCP_MODE;

// Notify codes sent to the owner in the WM_COMMAND message.
#define CCPN_CUT    0
#define CCPN_COPY   1
#define CCPN_PASTE  2
#define CCPN_HIDDEN 3

WINCOMMCTRLAPI HWND WINAPI CcpControl_Create(HINSTANCE hInst, HWND hwndOwner, UINT idCcpCtl);
WINCOMMCTRLAPI BOOL WINAPI CcpControl_Show(HWND hwndCCP, CCP_MODE cmMode, DWORD dwStyle, 
                            POINT *ptSelStart, POINT *ptSelEnd, LONG lSelStartHeight, LONG lSelEndHeight);
WINCOMMCTRLAPI BOOL WINAPI CcpControl_Move(HWND hwndCCP, POINT *pptSelStart, POINT *pptSelEnd, LONG lSelStartHeight, LONG lSelEndHeight);
WINCOMMCTRLAPI VOID WINAPI CcpControl_Destroy(HWND hwndCCP); 
...
WINCOMMCTRLAPI HWND  WINAPI CommandBar_InsertComboBoxEx(HWND hwndCB, HINSTANCE hInstance,
									   int  iWidth, UINT dwStyle, UINT dwExStyle,
									   WORD idComboBox, WORD iButton);
...
#define TBM_SETPADDING     (WM_USER+29)
#if (_WIN32_IE >= 0x0300)
...
#define LVS_EX_THEME            0x02000000 // Use theme asset for selector and increase the item height
#define LVS_EX_RESERVED         0x04000000 // Reserved
...
#define TTF_CENTERTIPABOVE      0x0800       // center the tooltip horizontally and position it above the tool
#endif
...
#define DTS_THEME           0x0100 // use theme elements when drawing
...
//======================================================================
// 9-grid Image struct and definitions

// Flags used in the Image9Grid struct
#define IMAGE9GRID_CROPTOP          0x0001
#define IMAGE9GRID_CROPBOTTOM       0x0010
#define IMAGE9GRID_CROPLEFT         0x0100
#define IMAGE9GRID_CROPRIGHT        0x1000

// Struct that stores 9-grid image information
typedef struct _Image9Grid
{
