...
#ifndef __IMultiLanguageInternal_FWD_DEFINED__
#define __IMultiLanguageInternal_FWD_DEFINED__
typedef interface IMultiLanguageInternal IMultiLanguageInternal;
#endif 	/* __IMultiLanguageInternal_FWD_DEFINED__ */
...
#ifndef __IMultiLanguageInternal_INTERFACE_DEFINED__
#define __IMultiLanguageInternal_INTERFACE_DEFINED__

/* interface IMultiLanguageInternal */
/* [unique][uuid][object] */ 

typedef /* [unique] */ IMultiLanguageInternal __RPC_FAR *LPMULTILANGUAGEINTERNAL;


EXTERN_C const IID IID_IMultiLanguageInternal;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("2cf616d7-ea86-4c18-8e23-305acc6003fe")
    IMultiLanguageInternal : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE ConvertStringToUnicodeInternal( 
            /* [out][in] */ DWORD __RPC_FAR *pdwMode,
            /* [in] */ DWORD dwEncoding,
            /* [in] */ CHAR __RPC_FAR *pSrcStr,
            /* [out][in] */ UINT __RPC_FAR *pcSrcSize,
    ...
    typedef struct IMultiLanguageInternalVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IMultiLanguageInternal __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *ConvertStringToUnicodeInternal )( 
            IMultiLanguageInternal __RPC_FAR * This,
            /* [out][in] */ DWORD __RPC_FAR *pdwMode,
            /* [in] */ DWORD dwEncoding,
            /* [in] */ CHAR __RPC_FAR *pSrcStr,
        ...
        END_INTERFACE
    } IMultiLanguageInternalVtbl;

    interface IMultiLanguageInternal
    {
        CONST_VTBL struct IMultiLanguageInternalVtbl __RPC_FAR *lpVtbl;
    };
...
#define IMultiLanguageInternal_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IMultiLanguageInternal_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IMultiLanguageInternal_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IMultiLanguageInternal_ConvertStringToUnicodeInternal(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize)	\
    (This)->lpVtbl -> ConvertStringToUnicodeInternal(This,pdwMode,dwEncoding,pSrcStr,pcSrcSize,pDstStr,pcDstSize)
...
HRESULT STDMETHODCALLTYPE IMultiLanguageInternal_ConvertStringToUnicodeInternal_Proxy( 
    IMultiLanguageInternal __RPC_FAR * This,
    /* [out][in] */ DWORD __RPC_FAR *pdwMode,
    /* [in] */ DWORD dwEncoding,
    /* [in] */ CHAR __RPC_FAR *pSrcStr,
...
void __RPC_STUB IMultiLanguageInternal_ConvertStringToUnicodeInternal_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IMultiLanguageInternal_INTERFACE_DEFINED__ */
...
/* interface __MIDL_itf_mlang_0097 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_mlang_0097_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mlang_0097_v0_0_s_ifspec;
