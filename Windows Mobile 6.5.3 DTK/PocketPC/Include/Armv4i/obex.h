...
EXTERN_C const IID IID_IObexResponse;
    ...
    public:
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE GetLastResponseCode( 
            /* [size_is][out] */ BYTE __RPC_FAR *pResponseCode) = 0;
    ...
    typedef struct IObexResponseVtbl
    {
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetLastResponseCode )( 
            IObexResponse __RPC_FAR * This,
            /* [size_is][out] */ BYTE __RPC_FAR *pResponseCode);
    ...
    interface IObexResponse
    {
        CONST_VTBL struct IObexResponseVtbl __RPC_FAR *lpVtbl;
    };
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IObexResponse_GetLastResponseCode_Proxy( 
    IObexResponse __RPC_FAR * This,
    /* [size_is][out] */ BYTE __RPC_FAR *pResponseCode);


void __RPC_STUB IObexResponse_GetLastResponseCode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
