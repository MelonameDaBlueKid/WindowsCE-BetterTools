...
typedef enum tagSHGDN
{
    ...
    SHGDN_FORADDRESSBAR      = 0x4000,  // UI friendly parsing name
...
//
//  Following flag is set only if UNDER_WINCE is defined
//   SBSP_FULLSCREENDOCUMENT -- document is opened with fullscreen option set
//
...
#define SBSP_FULLSCREENDOCUMENT 0x20000
